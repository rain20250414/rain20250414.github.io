(function () {
   ...
   * add directives
   */
  var apptem = angular.module('angular-echarts', ['angular-echarts.theme', 'angular-echarts.util']);
  var types = ['line', 'bar', 'area', 'pie', 'donut', 'gauge', 'map', 'radar', 'heatmap'];
  for (var i = 0, n = types.length; i < n; i++) {
    (function (type) {
      apptem.directive(type + 'Chart', ['$http', 'theme', 'util', function ($http, theme, util) {
        return {
          restrict: 'EA',
